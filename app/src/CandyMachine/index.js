...
const CandyMachine = ({ walletAddress }) => {
  ...
  const getCandyMachineState = async () => {
    ...
    const itemsRemaning = itemsAvailable - itemsRedeemed;
    ...
    setCandyMachine({
      ...
      state :{
        ...
        isSoldOut:itemsRemaning ===0,
        isActive:
        (presale||candyMachine.data.goLiveDate.toNumber()< new Date().getTime()/1000)&&
        (candyMachine.endSettings ? candyMachine.endSettings.endSettingType.date ?candyMachine.endSettings.number.toNumber()>
        new Date().getTime()/1000:itemsRedeemed<candyMachine.endSettings.number.toNumber():true),
        isPresale:presale,
    ...
    console.log({
      itemsAvailable, itemsRedeemed, itemsRemaning, goLiveDate, goLiveDateTimeString
    })
  };
